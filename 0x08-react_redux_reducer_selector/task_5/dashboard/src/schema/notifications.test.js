...
describe("Test for Notifications.js", () => {
  it("verify that the function returns the expected data", () => {
    ...
    expect(context).toEqual(expect.arrayContaining(expectedResult));
  });
  ...
  it("normalized data has a correct result array", () => {
    ...
    expect(normalized.result).toEqual(data);
  });
  ...
  it("should have a correct notification entity", () => {
    ...
    expect(normalized.entities.notification["5debd7642e815cd350407777"]).toEqual(notification);
  });
});